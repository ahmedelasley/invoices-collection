...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">الإعدادات</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ البنوك</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
					...
					<div class="col-xl-12">
						<div class="card mg-b-20">
							<div class="card-header pb-0">
								...
								@can('اضافة بنك')
									<a class="modal-effect btn btn-outline-primary " data-effect="effect-scale" data-toggle="modal" href="#modaldemo8">إضافة بنك</a>
								@endcan
								</div>
							</div>
							<div class="card-body">
									...
									<table id="example1" class="table key-buttons text-md-nowrap">
										<thead>
											<tr>
												...
												<th class="border-bottom-0">أسم البنك</th>
						...
						<div class="modal-dialog" role="document">
							<div class="modal-content modal-content-demo">
								<div class="modal-header">
									<h6 class="modal-title">إضافة بنك</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
								</div>
								<form action="{{route('sections.store')}}" method="post" autocomplete="off">
									...
									<div class="modal-body">
										...
										<div class="form-group">
											<label for="exampleInputTextarea1">الوصف</label>
