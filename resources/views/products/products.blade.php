					...
					<div class="col-xl-12">
						<div class="card mg-b-20">
							<div class="card-header pb-0">
								...
								@can('اضافة منتج')
									<a class="modal-effect btn btn-outline-primary " data-effect="effect-scale" data-toggle="modal" href="#exampleModal"><i class="fas fa-plus"></i>&nbsp;إضافة منتج</a>
								@endcan
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <label class="my-1 mr-2" for="inlineFormCustomSelectPref">البنك</label>
							...
							<div class="modal-content">
								...
								<div class="modal-body">
									...
									<form action="products/update" method="post" autocomplete="off">
										...
										<div class="form-group">
											<label class="my-1 mr-2" for="inlineFormCustomSelectPref">اسم البنك</label>
