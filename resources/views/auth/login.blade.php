...
@section('title')
تسجيل الدخول - العسلي لإدارة الفواتير
@stop
							...
							<div class="row">
								<div class="col-md-10 col-lg-10 col-xl-9 mx-auto">
									<div class="card-sigin">
										<div class="mb-5 d-flex"> <a href="{{ url('/' . $page='home') }}"><img src="{{URL::asset('assets/img/brand/elasley.png')}}" class="sign-favicon ht-100" alt="logo"></a></div>
										<div class="card-sigin">
